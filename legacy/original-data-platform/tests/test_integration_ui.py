...
def test_ui_runtime_lists_fixture_and_reports_waiting_without_fabricated_inputs():
    ...
    assert "journey-start-animation-sprite.png" in static_css
    for asset in (
    ...
    for asset in (
        ...
        "journey-start-frame-5.png",
        "journey-start-frame-6.png",
        "journey-start-frame-7.png",
        "journey-start-frame-8.png",
        ...
        "journey-complete-frame-5.png",
        "journey-complete-frame-6.png",
        "journey-complete-frame-7.png",
        "journey-complete-frame-8.png",
