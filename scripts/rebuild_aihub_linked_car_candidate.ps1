param(
    ...
    [string]$LinkedWindows = "data/interim/aihub/linked_vehicle_car_windows_2000.csv",
    [string]$Dataset = "data/interim/aihub/aihub_120_agg_linked_car_train3.csv",
    [string]$Manifest = "data/interim/aihub/aihub_linked_car_train3_manifest.json",
    [string]$Model = "data/interim/aihub/hist_120_linked_car_train3.joblib",
    [string]$Metrics = "data/interim/aihub/hist_120_linked_car_train3_metrics.json"
)
